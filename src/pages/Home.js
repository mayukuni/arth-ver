...
export default function Home() {
  return (
    <div>
      ...
      <div id='home' className="bg-[#3C3D37] w-screen p-10 px-20 font-montserrat">
        ...
        <div className="text-xl h-[75vh] flex items-center justify-center my-14 mt-28">
  <div className="w-3/4 flex flex-col items-center text-[#ECDFCC] p-12 text-[1.5rem] mx-20 border-2 border-[#697565] ">
    <p className="my-1">
  ...
  <a href="https://www.instagram.com/arthurorcy/" target="_blank" className="w-[50%] mx-20">
    <img src={photo} id="photo" className="rounded-full border-2 border-[#697565] hover:border-[#ECDFCC]" />
  </a>
</div>

        <hr className='border-[#697565]' id='projects'/>
        <div className='my-20'>
          <h1 className='text-5xl text-[#ECDFCC] font-semibold mx-20'>Projetos</h1>
          <ProjectCard 
        ...
        <div className='my-10 flex flex-col items-center my-20'>
          <h1 className='text-5xl text-[#ECDFCC] mb-10 font-extrabold'>Onde me encontrar</h1>
          <div className='flex place-content-evenly bg-[#697565] rounded-lg p-10 w-1/4'>
